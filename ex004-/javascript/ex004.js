...
/*-----------------------------------------------*/
document.write(`Olá,<strong> ${nome}</strong>! Seu nome tem ${nome.length} letras.`); /*document.write escreve na tela direto, sem precisar de telinha de alert, prompt por exemplo.
