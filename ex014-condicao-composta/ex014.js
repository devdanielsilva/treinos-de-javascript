...
let res = document.querySelector('div#res');
    ...
    res.innerHTML = `<br><p>Vivendo em <strong> ${país} .</strong> </p>`;/*Aspas com crase, podemos concatenar com a variável usando o símbolo de cifrão $ e sinais de chaves, {} Abre chaves e fecha chaves. E fica assim: ${Nome da Variável aqui dentro}; */
