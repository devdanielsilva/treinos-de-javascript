...
function calcular() {
  ...
  if (vel < 50) {
    res.innerHTML +=
      "<br><p>Você está no <strong>LIMITE</strong> dirija com atenção e respeite o limite de velocidade.</p>";
    res.innerHTML += `<br><p>Dirija sempre com <strong>CINTO</strong> de segurança!</p>`;
  } else if (vel > 50) {
    res.innerHTML +=
      "<br><p>Você está <strong>MULTADO</strong> por excesso de velocidade.</p>";
    res.innerHTML += `<br><p>Dirija sempre com <strong>CINTO</strong> de segurança!</p>`;
  }
}