...
! - Sinal de Exclamação: Serve para negação, ou seja, quer dizer não.<br>
&& - Dois e comerciais: Serve para conjunção, é chamado de elógico.<br>
|| - Sinal de pipe: Serve para disjunção, é chamado de oulógico. <br>
