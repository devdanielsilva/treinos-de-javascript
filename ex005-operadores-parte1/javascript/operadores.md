...
<hr>
Para toda expressão que tenha um operador relacional ligado a ela, o resultado dessa expressão vai sempre ser um valor booleano. Um valor do tipo Verdadeiro ou Falso. <br>
<hr>
...
8 >= 8 É verdadeiro (true), porque 8 não maior que 8 mas, é igual a 8. <br>
